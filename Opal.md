...
> **Full reference:** [Concurrency](docs/05-concurrency/concurrency.md) — actors, parallel blocks, async/futures, supervisors, design rationale
...
**Lock file:** `opal.lock` is auto-generated by `opal pkg install` and records exact resolved versions. Commit it to version control for reproducible builds.
